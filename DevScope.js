// ==UserScript==
// @name         DevScope 开发者工具 v5.4.6
// @namespace    devtools-sidebar-native
// @version      5.4.6
// @description  完整独立调试工具 - 最终稳定版
// @author       Developer
// @run-at       document-end
// @match        *://*/*
// @grant        none
...
(function() {
    ...
    const SVG = {
        ...
        pin: '<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 2 L12 22 M5 9 L12 2 L19 9"/></svg>'
    };
    ...
    function createStyles() {
        ...
        style.textContent = `
            ...
            .devtools-toggle-btn {
                ...
                z-index: 2147483647; background: #333; color: #fff; border: none;
    ...
    function updateHighlightPosition() {
        const overlay = document.getElementById('devtools-highlight-overlay');
        if (!overlay || overlay.style.display === 'none' || !selectedElement) return;
    ...
    function init() {
        ...
        hijackNetwork();
        addKeyboardShortcut();
        addScrollListener();   // 高亮跟随滚动
        console.log('DevScope v5.4.6 已加载');
    }
